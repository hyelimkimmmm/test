function check2() {
	...
	if($.trim($(".check1:checked").length <3)){
		alert("관심사는 3개이상 선택해주세요");
		$(".check1").focus();
	}
	...
	function si(z) {
		...
		if (z.value == "a")	var giyek = sigungu_a;
		else if (z.value == "b")var giyek = sigungu_b;
		else if (z.value == "c")var giyek = sigungu_c;
		else if (z.value == "d")var giyek = sigungu_d;
		else if (z.value == "e")var giyek = sigungu_e;
		else if (z.value == "f")var giyek = sigungu_f;
		else if (z.value == "g")var giyek = sigungu_g;
		else if (z.value == "h")var giyek = sigungu_h;
		else if (z.value == "i")var giyek = sigungu_i;
		else if (z.value == "j")var giyek = sigungu_j;
		else if (z.value == "k")var giyek = sigungu_k;
		else if (z.value == "l")var giyek = sigungu_l;
		else if (z.value == "n")var giyek = sigungu_n;
		else if (z.value == "m")var giyek = sigungu_m;
		else if (z.value == "o")var giyek = sigungu_o;
		else if (z.value == "p")var giyek = sigungu_p;
		else if (z.value == "q")var giyek = sigungu_q;
